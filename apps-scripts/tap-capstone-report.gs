...
function loadData(ss) {
  var raw = ss.getSheetByName('All Apprentices Impact Data (RAW)');
  if (!raw) throw new Error('Source sheet "All Apprentices Impact Data (RAW)" not found. Check the tab name and re-run.');
